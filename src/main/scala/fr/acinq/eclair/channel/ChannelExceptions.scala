...
case class CannotCloseWithUnsignedChanges      (override val channelId: ByteVector32) extends ChannelException(channelId, "cannot close when there are unsigned changes")
