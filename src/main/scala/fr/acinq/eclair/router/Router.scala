...
object Router {
  ...
  case class RouterConf(initRouteMaxLength: Int, initCltvMaxDelta: CltvExpiryDelta, maxParts: Int, maxChannelFailures: Int = 4, maxStrangeNodeFailures: Int = 6, maxRemoteAttempts: Int = 6)
