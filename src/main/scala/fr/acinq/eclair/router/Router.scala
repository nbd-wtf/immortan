...
object Router {
  ...
  case class RouterConf(routeHopDistance: Int, maxCltvDelta: CltvExpiryDelta, mppMinPartAmount: MilliSatoshi, maxChannelFailures: Int = 6, maxStrangeNodeFailures: Int = 6, maxRemoteAttempts: Int = 6)
