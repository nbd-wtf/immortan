...
object Router {
  ...
  case class RouterConf(initRouteMaxLength: Int, initCltvMaxDelta: CltvExpiryDelta, maxChannelFailures: Int = 4, maxStrangeNodeFailures: Int = 6, maxRemoteAttempts: Int = 6)
