...
object Router {
  ...
  case class RouterConf(initRouteMaxLength: Int, routeMaxCltv: CltvExpiryDelta, maxChannelFailures: Int = 4, maxStrangeNodeFailures: Int = 6, maxRemoteAttempts: Int = 10)
