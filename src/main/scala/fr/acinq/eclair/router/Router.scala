...
object Router {
  ...
  case class RouterConf(initRouteMaxLength: Int, routeMaxCltv: CltvExpiryDelta, maxDirectionFailures: Int = 4, maxStrangeNodeFailures: Int = 6, maxRemoteAttempts: Int = 6)
