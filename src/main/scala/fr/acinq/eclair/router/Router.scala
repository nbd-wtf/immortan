...
object Router {
  ...
  case class RouterConf(initRouteMaxLength: Int, routeMaxCltv: CltvExpiryDelta = CltvExpiryDelta(2016), maxChannelFailures: Int = 3, maxStrangeNodeFailures: Int = 6, maxRemoteAttempts: Int = 6)
