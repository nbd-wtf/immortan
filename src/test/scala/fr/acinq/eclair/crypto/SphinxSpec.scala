...
import fr.acinq.eclair.{CltvExpiry, MilliSatoshi, UInt64, randomKey}
...
class SphinxSpec extends AnyFunSuite {
  ...
  test(
    ...
    assert(
      serializePaymentOnion(
        onion
      ) == hex""
    )

    val Right(DecryptedPacket(payload0, nextPacket0, sharedSecret0)) =
      peel(privKeys(0), associatedData, onion)
    val Right(DecryptedPacket(payload1, nextPacket1, sharedSecret1)) =
      peel(privKeys(1), associatedData, nextPacket0)
    val Right(DecryptedPacket(payload2, nextPacket2, sharedSecret2)) =
      peel(privKeys(2), associatedData, nextPacket1)
    val Right(DecryptedPacket(payload3, nextPacket3, sharedSecret3)) =
      peel(privKeys(3), associatedData, nextPacket2)
    val Right(DecryptedPacket(payload4, nextPacket4, sharedSecret4)) =
  ...
  test(
    ...
    assert(
      serializePaymentOnion(
        onion
      ) == hex""
    )
  ...
  test(
    ...
    val Right(DecryptedPacket(payload, nextPacket, _)) =
      peel(privKeys(0), associatedData, onion)
  ...
  test("create trampoline payment packet") {
    ...
    assert(
      serializeTrampolineOnion(
        onion
      ) == hex""
    )
    ...
    val Right(DecryptedPacket(payload3, nextPacket3, sharedSecret3)) =
      peel(privKeys(3), associatedData, nextPacket2)
    val Right(DecryptedPacket(payload4, _, sharedSecret4)) =
      peel(privKeys(4), associatedData, nextPacket3)
    assert(
      Seq(
        payload0,
  ...
  test("decrypt failure message") {
    ...
    val expected =
      DecryptedFailurePacket(publicKeys.head, InvalidOnionKey(ByteVector32.One))

    val packet1 =
      FailurePacket.create(sharedSecrets.head, expected.failureMessage)
    assert(packet1.length === FailurePacket.PacketLength)

    val Success(decrypted1) = FailurePacket.decrypt(
      packet1,
    ...
    val Success(decrypted2) = FailurePacket.decrypt(
      packet2,
    ...
    val Success(decrypted3) = FailurePacket.decrypt(
      packet3,
  ...
  test("last node replies with a failure message (reference test vector)") {
    for (
      ...
      // node #0
      val Right(DecryptedPacket(_, packet1, sharedSecret0)) =
        peel(privKeys(0), associatedData, packet)
      // node #1
      val Right(DecryptedPacket(_, packet2, sharedSecret1)) =
        peel(privKeys(1), associatedData, packet1)
      // node #2
      val Right(DecryptedPacket(_, packet3, sharedSecret2)) =
        peel(privKeys(2), associatedData, packet2)
      // node #3
      val Right(DecryptedPacket(_, packet4, sharedSecret3)) =
        peel(privKeys(3), associatedData, packet3)
      // node #4
      val Right(lastPacket @ DecryptedPacket(_, _, sharedSecret4)) =
        peel(privKeys(4), associatedData, packet4)
      ...
      val Success(DecryptedFailurePacket(pubkey, failure)) =
        FailurePacket.decrypt(error4, sharedSecrets)
  ...
  test(
    ...
    for (
      ...
      val Right(DecryptedPacket(_, packet2, sharedSecret1)) =
        peel(privKeys(1), associatedData, packet1)
      // node #2
      val Right(DecryptedPacket(_, _, sharedSecret2)) =
        peel(privKeys(2), associatedData, packet2)
      ...
      val Success(DecryptedFailurePacket(pubkey, failure)) =
        FailurePacket.decrypt(error2, sharedSecrets)
  ...
  test("create blinded route (reference test vector)") {
    ...
    val blindedRoute =
      RouteBlinding.create(sessionKey, publicKeys, routeBlindingPayloads)
    assert(blindedRoute.introductionNode.publicKey === publicKeys(0))
    assert(blindedRoute.introductionNodeId === publicKeys(0))
    assert(
      blindedRoute.introductionNode.blindedPublicKey === PublicKey(
        hex"02ec68ed555f5d18b12fe0e2208563c3566032967cf11dc29b20c345449f9a50a2"
      )
    )
    assert(
      blindedRoute.introductionNode.blindingEphemeralKey === PublicKey(
        hex"031b84c5567b126440995d3ed5aaba0565d71e1834604819ff9c17f5e9d5dd078f"
      )
    )
    assert(
      blindedRoute.introductionNode.encryptedPayload === hex"af4fbf67bd52520bdfab6a88cd4e7f22ffad08d8b153b17ff303f93fdb4712"
    )
    assert(
      blindedRoute.blindedNodeIds === Seq(
        ...
        PublicKey(
          hex"022b09d77fb3374ee3ed9d2153e15e9962944ad1690327cbb0a9acb7d90f168763"
        ),
        PublicKey(
          hex"03d9f889364dc5a173460a2a6cc565b4ca78931792115dd6ef82c0e18ced837372"
        ),
        PublicKey(
          hex"03bfddd2253b42fe12edd37f9071a3883830ed61a4bc347eeac63421629cf032b5"
        ),
        PublicKey(
          hex"03a8588bc4a0a2f0d2fb8d5c0f8d062fb4d78bfba24a85d0ddeb4fd35dd3b34110"
        )
      )
    )
    assert(
      blindedRoute.subsequentNodes.map(_.blindedPublicKey) === Seq(
        PublicKey(
          hex"022b09d77fb3374ee3ed9d2153e15e9962944ad1690327cbb0a9acb7d90f168763"
        ),
        PublicKey(
    ...
    assert(
      blindedRoute.encryptedPayloads === blindedRoute.introductionNode.encryptedPayload +: blindedRoute.subsequentNodes
        .map(_.encryptedPayload)
    )
    assert(
      blindedRoute.subsequentNodes.map(_.encryptedPayload) === Seq(
    ...
    val Success((payload0, ephKey1)) = RouteBlinding.decryptPayload(
      privKeys(0),
      blindedRoute.introductionNode.blindingEphemeralKey,
      blindedRoute.encryptedPayloads(0)
    )
    assert(payload0 === routeBlindingPayloads(0))
    assert(
      ephKey1 === PublicKey(
        hex"035cb4c003d58e16cc9207270b3596c2be3309eca64c36b208c946bbb599bfcad0"
      )
    )
    ...
    assert(
      RouteBlinding
        .derivePrivateKey(privKeys(1), ephKey1)
        .publicKey === blindedRoute.blindedNodeIds(1)
    )
    val Success((payload1, ephKey2)) = RouteBlinding.decryptPayload(
      privKeys(1),
      ephKey1,
    ...
    assert(
      ephKey2 === PublicKey(
        hex"02e105bc01a7af07074a1b0b1d9a112a1d89c6cd87cc4e2b6ba3a824731d9508bd"
      )
    )
    ...
    assert(
      RouteBlinding
        .derivePrivateKey(privKeys(2), ephKey2)
        .publicKey === blindedRoute.blindedNodeIds(2)
    )
    val Success((payload2, ephKey3)) = RouteBlinding.decryptPayload(
      privKeys(2),
      ephKey2,
    ...
    assert(
      RouteBlinding
        .derivePrivateKey(privKeys(3), ephKey3)
        .publicKey === blindedRoute.blindedNodeIds(3)
    )
    val Success((payload3, ephKey4)) = RouteBlinding.decryptPayload(
      privKeys(3),
      ephKey3,
    ...
    assert(
      ephKey4 === PublicKey(
        hex"020a6d1951916adcac22125063f62c35b3686f36e5db2f77073f3d35b19c7a118a"
      )
    )
    ...
    assert(
      RouteBlinding
        .derivePrivateKey(privKeys(4), ephKey4)
        .publicKey === blindedRoute.blindedNodeIds(4)
    )
    val Success((payload4, _)) = RouteBlinding.decryptPayload(
      privKeys(4),
      ephKey4,
      blindedRoute.encryptedPayloads(4)
    )
  ...
  test("concatenate blinded routes (reference test vector)") {
    ...
    val (blindingOverride, blindedRouteEnd, payloadsEnd) = {
      ...
      val blindedRoute =
        RouteBlinding.create(sessionKey, publicKeys.drop(2), payloads)
      assert(
    ...
    assert(
      blindedRoute.blindedNodeIds === Seq(
        PublicKey(
          hex"0303176d13958a8a59d59517a6223e12cf291ba5f65c8011efcdca0a52c3850abc"
        ),
        PublicKey(
          hex"03adbdd3c0fb69641e96de2d5ac923ffc0910d3ed4dfe2314609fae61a71df4da2"
        ),
        PublicKey(
          hex"021026e6369e42b7f6d723c0c56a3e0b4d67111f07685bd03e9fa6d93ac6bb6dbe"
        ),
        PublicKey(
          hex"02ba3db3fe7f1ed28c4d82f28cf358373cbf3241a16aba265b1b6fb26f094c0c7f"
        ),
        PublicKey(
          hex"0379d4ca14cb19e2f7bcb217d36267e3d03b027bc4228923967f5b2e32cbb763c1"
        )
      )
    )
    assert(
    ...
    assert(
      ephKey1 === PublicKey(
        hex"02be4b436dbc6cfa43d7d5652bc630ffdaf0dac93e6682db7950828506055ad1a7"
      )
    )
    ...
    assert(
      ephKey2 === PublicKey(
        hex"03fb82254d740754efddc3318674f4e26cefcb8dec42a3910c08c64d19f25e50b7"
      )
    )
    ...
    assert(
      RouteBlinding
        .decryptPayload(privKeys(2), ephKey2, blindedRoute.encryptedPayloads(2))
        .isFailure
    )
    assert(
      RouteBlinding
        .derivePrivateKey(privKeys(2), blindingOverride)
        .publicKey === blindedRoute.blindedNodeIds(2)
    )
    val Success((payload2, ephKey3)) = RouteBlinding.decryptPayload(
      privKeys(2),
    ...
    assert(
      ephKey3 === PublicKey(
        hex"03932f4ab7605e8c046b5677becd4d61fdfdc8b9d10f1e9c3080ced0d64fd76931"
      )
    )
    ...
    assert(
      ephKey4 === PublicKey(
        hex"037bceb365470d24f8204c622e1b7959c6beeb774c634640de6c8401079159fc58"
      )
    )
    ...
    val Success((payload4, ephKey5)) = RouteBlinding.decryptPayload(
      privKeys(4),
      ephKey4,
      blindedRoute.encryptedPayloads(4)
    )
    ...
    assert(
      ephKey5 === PublicKey(
        hex"0339ddfa85a2155fb27e94742885fad85696e54920aa148cb86e00bcb8ee346bd4"
      )
    )
  }
  ...
  test("invalid blinded route") {
    ...
    assert(
      RouteBlinding
        .decryptPayload(privKeys(0), randomKey.publicKey, encryptedPayloads(0))
        .isFailure
    )
  ...
  test("create payment packet to blinded route (reference test vector)") {
    ...
    val (blindedRoute, blindingEphemeralKey0) = {
      val recipientSessionKey = PrivateKey(
        hex"0101010101010101010101010101010101010101010101010101010101010101"
      )
      (
    ...
    val nodeIds = publicKeys.take(2) ++ Seq(
      blindedRoute.introductionNodeId
    ) ++ blindedRoute.subsequentNodes.map(_.blindedPublicKey)
    assert(
      blindedRoute.encryptedPayloads === Seq(
    ...
    val payloads = Seq(
      ...
      TlvStream[OnionPaymentPayloadTlv](
        OnionPaymentPayloadTlv.AmountToForward(MilliSatoshi(500)),
        OnionPaymentPayloadTlv.OutgoingCltv(CltvExpiry(1000)),
        OnionPaymentPayloadTlv.OutgoingChannelId(10)
      ),
      TlvStream[OnionPaymentPayloadTlv](
        OnionPaymentPayloadTlv.AmountToForward(MilliSatoshi(450)),
        OnionPaymentPayloadTlv.OutgoingCltv(CltvExpiry(900)),
        OnionPaymentPayloadTlv.OutgoingChannelId(15)
      ),
      // The sender includes the blinding key and the first encrypted recipient data in the introduction node's payload.
      TlvStream[OnionPaymentPayloadTlv](
        OnionPaymentPayloadTlv.AmountToForward(MilliSatoshi(400)),
        OnionPaymentPayloadTlv.OutgoingCltv(CltvExpiry(860)),
        OnionPaymentPayloadTlv.BlindingPoint(blindingEphemeralKey0),
      ...
      TlvStream[OnionPaymentPayloadTlv](
        OnionPaymentPayloadTlv.AmountToForward(MilliSatoshi(250)),
        OnionPaymentPayloadTlv.OutgoingCltv(CltvExpiry(750)),
        OnionPaymentPayloadTlv.EncryptedRecipientData(
          blindedRoute.encryptedPayloads(1)
        )
      ),
    ...
    val senderSessionKey = PrivateKey(
      hex"0202020202020202020202020202020202020202020202020202020202020202"
    )
    ...
    assert(
      serializePaymentOnion(
        onion
      ) == hex""
    )
    ...
    val Right(DecryptedPacket(payload2, nextPacket2, sharedSecret2)) =
      peel(privKeys(2), associatedData, nextPacket1)
    val tlvs2 = PaymentOnionCodecs.tlvPerHopPayloadCodec
      .decode(payload2.bits)
      .require
      .value
    assert(
      tlvs2.get[OnionPaymentPayloadTlv.BlindingPoint].map(_.publicKey) === Some(
    ...
    val blindedPrivKey3 =
      RouteBlinding.derivePrivateKey(privKeys(3), blindingEphemeralKey1)
    val Right(DecryptedPacket(payload3, nextPacket3, sharedSecret3)) =
      peel(blindedPrivKey3, associatedData, nextPacket2)
    val tlvs3 = PaymentOnionCodecs.tlvPerHopPayloadCodec
    ...
    // derive the private key corresponding to its blinded node ID and decrypt the onion.
    val blindedPrivKey4 =
      RouteBlinding.derivePrivateKey(privKeys(4), blindingEphemeralKey2)
    val Right(DecryptedPacket(payload4, nextPacket4, sharedSecret4)) =
      peel(blindedPrivKey4, associatedData, nextPacket3)
    val tlvs4 = PaymentOnionCodecs.tlvPerHopPayloadCodec
      .decode(payload4.bits)
      .require
      .value
    assert(tlvs4.get[OnionPaymentPayloadTlv.EncryptedRecipientData].nonEmpty)
    val Success((recipientTlvs4, _)) = RouteBlindingEncryptedDataCodecs.decode(
      privKeys(4),
    ...
    assert(
      packets(0).hmac == ByteVector32(
        hex"4e73505d3e9f5bd9816e6eb2b697c28a3dc29c5a0328ebfd261ececbde063c15"
      )
    )
    assert(
      packets(1).hmac == ByteVector32(
        hex"1841603b10d16dd84cf0917db581c765bc602a323f09cd2784481ef198354ea5"
      )
    )
    assert(
      packets(2).hmac == ByteVector32(
        hex"059d613df54e969758395e643aabb04276b6fc64e01d5a4de63ec72dfbfb1a10"
      )
    )
    assert(
      packets(3).hmac == ByteVector32(
        hex"27c80773d5ab54e0b1ff0b068348394533d235e146e25db69236d2f8a580a919"
      )
    )
    assert(
      packets(4).hmac == ByteVector32(
